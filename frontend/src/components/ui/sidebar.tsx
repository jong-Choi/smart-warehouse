...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      className={cn(
        "group/sidebar-rail absolute left-0 top-0 z-20 h-full w-1 bg-transparent transition-colors hover:bg-sidebar-border/50",
        className
      )}
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex h-[60px] shrink-0 items-center gap-2", className)}
      {...props}
    />
  );
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 px-2 py-1.5 text-xs font-semibold",
        className
      )}
      {...props}
    />
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-sidebar-primary text-sidebar-primary-foreground ml-auto rounded-md px-1.5 py-0.5 text-xs font-medium",
        className
      )}
      {...props}
    />
