...
export function useSalesOverview(year?: number) {
  return useSuspenseQuery<{ success: boolean; data: SalesOverviewData }>({
...
export function useLocationSales(year?: number) {
  return useSuspenseQuery<{ success: boolean; data: LocationSalesData[] }>({
...
export function useMonthlySales(year: number) {
  return useSuspenseQuery<MonthlySalesResponse>({
...
export function useDailySales(year: number, month: number) {
  return useSuspenseQuery<DailySalesResponse>({
